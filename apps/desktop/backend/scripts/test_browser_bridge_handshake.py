...
HOST = os.environ.get("ADELE_BROWSER_BRIDGE_HOST", "127.0.0.1")
PORT = int(os.environ.get("ADELE_BROWSER_BRIDGE_PORT", "8765"))
TOKEN = os.environ.get("ADELE_BROWSER_BRIDGE_TOKEN", "dev-bridge-token")
