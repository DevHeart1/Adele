"""
ADELE — RAG Engine (Retrieval-Augmented Generation)
=======================================================
...
EMBEDDING_MODEL = os.environ.get("ADELE_EMBEDDING_MODEL", "text-embedding-004")
...
class RAGEngine:
    """
    Retrieval-Augmented Generation engine for ADELE.
